  ...
  return (
    <div className="flex flex-col flex-1">
        ...
        <div className="w-full mx-auto px-6 sm:px-6 lg:px-8 max-w-6xl">
          <div className="py-10 sm:py-16 md:py-20 lg:py-24 flex flex-col md:flex-row items-center relative z-10">
            <div className="w-full md:w-1/2 md:pr-8 mb-8 md:mb-0 relative z-10">
              <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4 leading-tight">
              ...
              <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 mb-8 sm:mb-8">
                The first online marketplace made specifically for vaulters. 
                Connect with sellers, find great deals, and vault higher.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 relative z-10 max-w-md mx-auto sm:mx-0">
                <Link 
                  to={RoutePaths.LISTINGS} 
                  className="flex justify-center items-center gap-2 w-full text-center px-5 py-3.5 text-base font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors shadow-md relative z-10"
                  onClick={(e) => {
                ...
                <Link 
                  to={RoutePaths.SELL} 
                  className="flex justify-center items-center w-full text-center px-5 py-3.5 text-base font-semibold text-blue-600 border-2 border-blue-600 rounded-lg hover:bg-blue-50 transition-colors relative z-10"
                  onClick={(e) => {
      ...
      <div className="bg-white py-16 sm:py-20 md:py-24">
        <div className="w-full mx-auto px-6 sm:px-6 lg:px-8 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-2">We've built the perfect platform for vaulters to find and sell poles with ease.</p>
          </div>
      ...
      <div className="bg-gray-50 py-16 sm:py-20 md:py-24">
        <div className="w-full mx-auto px-6 sm:px-6 lg:px-8 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-2">Getting your next pole or selling your current one is simple with PoleSwap.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-md sm:max-w-none mx-auto">
            ...
            <div className="relative px-4 sm:col-span-2 md:col-span-1 sm:mx-auto md:mx-0 sm:max-w-sm md:max-w-none">
      ...
      <div className="bg-gray-900 py-16 sm:py-20">
        <div className="w-full mx-auto px-6 sm:px-6 lg:px-8 max-w-6xl text-center">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-5 sm:mb-6">Ready to find your perfect pole?</h2>
          <p className="text-sm sm:text-base md:text-lg text-gray-300 mb-8 sm:mb-10 max-w-2xl mx-auto">Join hundreds of vaulters who have already found their ideal equipment through PoleSwap.</p>
          <div className="flex flex-col sm:flex-row gap-5 justify-center max-w-xs sm:max-w-md mx-auto">
            <Link 
              to={RoutePaths.LISTINGS} 
              className="px-6 sm:px-8 py-3.5 sm:py-4 text-base font-semibold bg-white text-blue-600 rounded-lg hover:bg-blue-50 transition-colors shadow-md w-full"
            >
              Browse Poles
            </Link>
            <Link 
              to={RoutePaths.SELL} 
              className="px-6 sm:px-8 py-3.5 sm:py-4 text-base font-semibold bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition-colors shadow-md w-full"
            >
              Sell Your Pole
            </Link>
          </div>
